...
var savep = [];
setInterval(()=>{
  document.getElementsByClassName("autoruncheck")[0].innerHTML = "Automatically run HTML and CSS ("+((autorun+"").slice(0,1).toUpperCase()+(autorun+"").slice(1))+")";
  document.getElementsByClassName("autoruncheckjs")[0].innerHTML = "Automatically run HTML, CSS and JS ("+((runjs+"").slice(0,1).toUpperCase()+(runjs+"").slice(1))+")";
